...
def push ( stack,item ):
		...
		print ("ukuran baju yang dikembalikan:",item)
...
def pop (stack) :
		...
		if (periksa_empty (stack)) :
			...
			return print ("ukuran baju pada lemari kosong")

		print ("ukuran baju yang diambil:",stack.pop())

		

def size (stack) :

		print ("jumlah baju pada lemari:" ,len(stack))
...
def top (stack):
		...
		if top < 0 :
			...
			print ("ukuran baju yang teratas:" , stack [top])
...
print (" tumpukan ukuran baju pada lemari ")

#Data awal stack

print ("ukuran baju yang yang berada pada tumpukan saat ini:  ",s) 
